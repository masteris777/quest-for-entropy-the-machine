# Forced complex structure: shows symbolically that a real orthogonal map with no
# real eigenvalues carries a unique compatible complex structure J (the "forced i"),
# and builds the test streams the rest of the chain measures against.
