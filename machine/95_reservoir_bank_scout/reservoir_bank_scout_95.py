# Reservoir-bank scout: tests whether splitting the number source into K independent
# banks (rather than one blended source) satisfies the fold's two competing demands at
# once - rotation-like structure AND records free of memory. This is where the
# sixteen generators come from.
...
def run_stage_a():
    ...
    # metrics_94.json, never against rounded display numbers)
