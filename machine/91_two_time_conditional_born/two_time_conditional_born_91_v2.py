# Two-time conditional statistics: counted transition frequencies compared against the
# squared-projection formula. Also the source of the shared instruments the rest of the
# chain uses - the observer frame (haar_frame), the counted kernels (counted_F) and the
# total-variation distance (row_max_tv).
...
# and applies to the phases only - geometry/Q/Z_C stay Procrustes.
...
if __name__ == "__main__":
    ...
    # Verdict (rules and thresholds declared before the run; Stage A as amended)
